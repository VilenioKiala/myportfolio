        ...
        <>
            <div className="banner px-6 md:px-16 lg:px-36 mygrid h-[100vh] lg:h-[90vh] justify-center items-center relative overflow-hidden">
                ...
                <Bobble
                    ...
                    bobbleSize={90}
                />
                <Banner className="col-start-1 col-end-13 md:col-start-3 lg:col-start-3 md:col-end-11 lg:col-end-11 relative z-10">
                    <H1>
            ...
            <Section className="px-6 md:px-16 lg:px-36 my-28 mygrid relative overflow-hidden">
                ...
                />
                <Bobble
                    initial={{ top: 60, left: 90 }}
                    end={{ top: 40, left: 80 }}
                    bobbleSize={90}
                />
                <div className="col-start-1 col-end-13 md:col-end-7 w-full h-[30rem] relative z-20">
                    <ServicesIllustration />
                </div>
                <div className="col-start-1 col-span-full md:col-start-7 relative z-20">
                    <SectionTitle
                        preTitle="SERVIÇOS"
                    ...
                    {tabSelectedIndex === 0 && (
                        <>
                            ...
                            <WorkCard
                                ...
                                openImageDisplayer={openImageDisplayer}
                                setImageOnDisplayer={setImageOnDisplayer}
                                className="md:hidden lg:block my-8"
                            />
                        </>
                    )}
            ...
            <Section className="px-6 md:px-16 lg:px-36 mygrid mt-28 relative overflow-hidden">
                ...
                />
                <Bobble
                    initial={{ top: 10, left: 95 }}
                    end={{ top: 37, left: 70 }}
                    bobbleSize={90}
                />
                <div className="col-start-1 col-end-12 md:col-end-7 w-full h-[30rem] relative z-20">
                    <HabilitiesIllustration />
                </div>
                <div className="col-start-1 md:col-start-7 col-span-full relative z-20">
                    <SectionTitle
                ...
                <SeeMoreButton
                    to="/sobremim"
                    className="col-span-full justify-self-end relative z-20"
                >
                    VER MAIS SOBRE MIM
                </SeeMoreButton>
            </Section>
            ...
            <Section className="px-6 md:px-16 lg:px-36 mygrid mt-28 items-center relative overflow-hidden">
                ...
                <div className="col-start-1 md:col-start-7 col-span-full">
                    <SectionTitle
                        text="Tem alguma ideia de aplicativo ou sistema em mente? Deixe-me ajudá-lo a tirar da sua mente e transformar em realidade!"
                        className="text-center md:text-left"
                    >
                    ...
                    <PrimaryButton
                        className="px-6 py-2 mt-2 block mx-auto md:mx-0"
                        onClick={openModal}
                    >
                        FALE COMIGO
                    </PrimaryButton>
